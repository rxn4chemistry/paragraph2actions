...
@click.command()
@click.option('--translation_models', '-t', multiple=True, help='Translation model file. If multiple are given, will '
                                                                'be an ensemble model.')
@click.option('--sentencepiece_model', '-p', required=True, help='SentencePiece model file')
...
def translate_actions(translation_models: Tuple[str, ...], sentencepiece_model: str, src_file: str, output_file: str):
    """
    ...
    """
    translator = Translator(translation_model=translation_models, sentencepiece_model=sentencepiece_model)
